...
export default function Home() {
  ...
  return (
    <>
      <main className="flex bg-slate-900 sm:py-4 items-center justify-center relative min-h-screen my-8">
          ...
          <div className="card sm:max-w-[32rem]">
            ...
            <div className="card-body">
              ...
              <p className="p-4 text-justify text-[#342c3da1]">
                ...
                TypeScript, Express.js, tailwindcss for developing responsive
                and scalable web applications and react-native for mobile
                applications by lavraging the capablity of expo to deliver
