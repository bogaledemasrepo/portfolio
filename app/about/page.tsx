            ...
            <div className="card w-full justify-self-center items-center shadow-none">
              ...
              <div className="card-body flex flex-col gap-4 p-10">
                <p className="max-w-[540px] text-lg text-[#342c3d76] text-justify p-2 md:p-5 align-middle md:px-10">
                  My name is Bogale Demas, live and work in Bahir Dar Ethiopia.
                  I enjoy coding and challenge of learning something new every
                  day. I spent most of may day expermenting with html, css,
                  javasript and js frameworks
                </p>
              </div>
              ...
              <div className="card-body flex flex-col gap-4">
                <p className="max-w-[540px]  text-lg text-[#342c3d76] text-justify p-5 align-middle px-10">
                  ...
                  of Technology since September 2019 - Julay 2023. I spent alot
                  of time to become Full-stack Js developer on Zero to mastery
                  Udemy courses. Thanks to telegram I get alot Udemy courses!.
                </p>
              </div>
            </div>
          </div>
